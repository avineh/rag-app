...
#קובץ הזרקת נתונים ראשוני – נזריק כמה משפטים פשוטים כדי שיהיה לנו מה לחפש אחריו בהמשך
#המודל הזה הוא חינמי וקטן יחסית (כ-400MB), אבל עושה עבודה טובה בהבנת משמעות של משפטים. 
def seed_real_data():
